...
const generateSlots = (startTime, endTime, bookedSlots = [], slotDuration = 15, isToday = false) => {
    const slots = [];
...
export const getAvailableSlots = async (req, res) => {
    try {
        ...
        for (const date of dates) {
            ...
            const slots = generateSlots(employee.workStart, employee.workEnd, bookedTimes, 15, isToday);
            if (slots.length > 0) {
